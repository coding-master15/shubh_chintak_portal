...
class LeadController extends Controller
{
    ...
    public function getnotifications(Request $request)
    {
                ...
                return Datatables::of($data)
                    ->addIndexColumn()
                    ->addColumn('action', function($row){
                      $btn = '<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalw'.$row->id.'">
                      View
                    </button>';
                      $btn.='<div class="modal fade" id="exampleModalw'.$row->id.'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelw'.$row->id.'" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabelw'.$row->id.'">'.$row->title.'</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
